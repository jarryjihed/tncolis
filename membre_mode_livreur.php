...
<body>
	<form name="myForm" action="action_demande.php" onsubmit="return validateForm()" method="post">
		<legend>Expédier ou recevoir un colis</legend>			
		...
		<div>
			...
			<table>
				...
				<tr>
					<td>
						<br />						
						<input type="text" name="details" placeholder="Détails">
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<br />						
						<textarea name="informationscomplementaires" cols="35" rows="5" placeholder="Informations complémentaires"></textarea>
					</td>
				</tr>	
				<tr>
					<td>
		...
		<div1>
			...
			<table>
				<tr>
					<td>
						<a href="membre.php">Déménagement</a>
					</td>
				</tr>
				<tr>
					<td>
						<br />						
						<a href="membre.php">Louer un véhicule</a>
					</td>
				</tr>
				<tr>
					<td>

...
<h1>TN_COLIS</h1>
		...
		<div>
			<table>
				...
				<tr>
					<td>
						<input type="date" name="date_naissance" min="1960-06-07" placeholder="Data de naissance"><br><br>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<input type="password" name="mdp" minlength="8" placeholder="Mot de Passe"><br><br>
					</td>
				</tr>
				<tr>
					<td>
						<input type="password" name="cmdp" minlength="8" placeholder="Confirmation de mot de passe"><br><br>
					</td>
				</tr>
